  ...
  videos: [
    {
      duration: 421,
      description:
        "Electric Universe - Alien Encounter Part 2 (Spirit Zone 97)",
      embed: true,
  ...
  images: [
    {
      ...
      uri150:
        "https://api-img.discogs.com/sSWjXKczZseDjX2QohG1Lc77F-w=/fit-in/150x150/filters:strip_icc():format(jpeg):mode_rgb()/discogs-images/R-66785-1213949871.jpeg.jpg",
      width: 600,
    },
    {
      height: 296,
      resource_url:
        "https://api-img.discogs.com/1iD31iOWgfgb2DpROI4_MvmceFw=/fit-in/600x296/filters:strip_icc():format(jpeg):mode_rgb():quality(96)/discogs-images/R-66785-1213950065.jpeg.jpg",
      type: "secondary",
      ...
      uri150:
        "https://api-img.discogs.com/Cm4Q_1S784pQeRfwa0lN2jsj47Y=/fit-in/150x150/filters:strip_icc():format(jpeg):mode_rgb()/discogs-images/R-66785-1213950065.jpeg.jpg",
      width: 600,
    },
  ],
